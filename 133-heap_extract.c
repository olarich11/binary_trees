...
/**
 * tree_height - Determines the height of a binary tree
 * @tree: A pointer to the tree's root node for measure the height
 *
 * Return: The height of a tree or 0 if tree is NULL
 */
...
/**
 * tree_size_h - Determines the sum of heights of a binary tree
 * @tree: A pointer to the tree root node for measure the height
 *
 ...
 * @node: Will be the last note in the traversal
